...
/**
 * REST controller for managing {@link com.myapp.app.domain.Shipping}.
 */
@RestController
@RequestMapping("/api")
public class ShippingResource {
    ...
    public ResponseEntity<ShippingDTO> partialUpdateShipping(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, shippingDTO.getId().toString())
        );
    }
