...
/**
 * REST controller for managing {@link com.myapp.app.domain.OrderItemProduct}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemProductResource {
    ...
    public ResponseEntity<OrderItemProductDTO> updateOrderItemProduct(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderItemProductDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<OrderItemProductDTO> partialUpdateOrderItemProduct(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderItemProductDTO.getId().toString())
        );
    }
