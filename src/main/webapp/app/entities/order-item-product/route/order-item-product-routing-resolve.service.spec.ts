...
describe('OrderItemProduct routing resolve service', () => {
  ...
  let resultOrderItemProduct: IOrderItemProduct | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IOrderItemProduct returned by find', () => {
      ...
      expect(resultOrderItemProduct).toEqual({ id: '9fec3727-3421-4967-b213-ba36557ca194' });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOrderItemProduct).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOrderItemProduct>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
