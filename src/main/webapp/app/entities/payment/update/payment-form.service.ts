...
type PaymentFormGroupContent = {
  ...
  cardNumber: FormControl<IPayment['cardNumber']>;
  cardHolderName: FormControl<IPayment['cardHolderName']>;
  cardExpirationMonth: FormControl<IPayment['cardExpirationMonth']>;
  cardExpirationYear: FormControl<IPayment['cardExpirationYear']>;
  cardCVV: FormControl<IPayment['cardCVV']>;
};
...
export class PaymentFormService {
  createPaymentFormGroup(payment: PaymentFormGroupInput = { id: null }): PaymentFormGroup {
    ...
    return new FormGroup<PaymentFormGroupContent>({
      ...
      cardExpirationMonth: new FormControl(paymentRawValue.cardExpirationMonth),
      cardExpirationYear: new FormControl(paymentRawValue.cardExpirationYear),
      cardCVV: new FormControl(paymentRawValue.cardCVV),
    });
  }
